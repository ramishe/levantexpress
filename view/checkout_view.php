...
if(isset($_SESSION["cart"])){
    ...
    ob_start();
    ?>
    <div class="container_checkout" id="container_checkout">
    ...
    foreach($_SESSION['cart'] as $prod_id => $quantity){ 
        ...
        ?>  
            <div class="un_produit_final_panier">
                <div class="name_produit_final_panier"><img src="./public/images/categories/<?=$r['category_id']?>/<?=$r['photo_name']?>" class="cart-item-image"/>
                    <?= $r["name"]?> x <?= $_SESSION['cart'][$r['id']]?>
                </div>
                <div class="prix_produit_final_panier">
...
<?php                
    ...
    echo "Il n'y a aucan produit pour paiment";
}
